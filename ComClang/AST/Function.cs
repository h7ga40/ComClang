...
namespace CppSharp.AST
{
	...
	public class Parameter : Declaration, ITypedDecl, IParameter
	{
		public Parameter()
		{
		...
		IQualifiedType IParameter.QualifiedType { get => QualifiedType; set => QualifiedType = (QualifiedType)value; }
		IExpression IParameter.DefaultArgument { get => defaultArgument; set => defaultArgument = (Expression)value; }
	...
	public class Function : DeclarationContext, ITypedDecl, IMangledDecl, IFunction
	{
		public Function()
		{
		...
		IQualifiedType IFunction.ReturnType { get => ReturnType; set => ReturnType = (QualifiedType)value; }

		public int ParameterCount => Parameters.Count;

		IFunctionTemplateSpecialization IFunction.SpecializationInfo { get => SpecializationInfo; set => SpecializationInfo = (FunctionTemplateSpecialization)value; }
		IFunction IFunction.InstantiatedFrom { get => InstantiatedFrom; set => InstantiatedFrom = (Function)value; }
		IQualifiedType IFunction.QualifiedType { get => QualifiedType; set => QualifiedType = (QualifiedType)value; }
	}
}