...
namespace CppSharp.AST
{
	...
	public abstract class Declaration : INamedDecl, IDeclaration
	{
		...
		public DeclarationKind DeclKind { get; set; }
		IDeclarationContext IDeclaration.Namespace { get => Namespace; set => Namespace = (DeclarationContext)value; }
		ISourceLocation IDeclaration.Location { get => Location; set => Location= (SourceLocation)value; }
		IDeclaration IDeclaration.CompleteDeclaration { get => CompleteDeclaration; set => CompleteDeclaration = (Declaration)value; }

		public int PreprocessedEntitieCount => PreprocessedEntities.Count;

		public int RedeclarationCount => Redeclarations.Count;

		IRawComment IDeclaration.Comment { get => Comment; set => Comment = (RawComment)value; }
		...
		public IPreprocessedEntity GetPreprocessedEntitie(int index)
		{
			return PreprocessedEntities[index];
		}

		public void AddPreprocessedEntitie(IPreprocessedEntity value)
		{
			PreprocessedEntities.Add((PreprocessedEntity)value);
		}

		public IDeclaration GetRedeclaration(int index)
		{
			return Redeclarations[index];
		}

		public void AddRedeclaration(IDeclaration value)
		{
			Redeclarations.Add((Declaration)value);
		}
	}
