...
namespace CppSharp.AST
{
	...
	public class ASTContext : IASTContext
	{
		...
		public int TranslationUnitCount => TranslationUnits.Count;
		...
		public ITranslationUnit FindOrCreateModule(string File)
		{
			return FindOrCreateTranslationUnit(File);
		}
		...
		public void AddTranslationUnit(ITranslationUnit value)
		{
			TranslationUnits.Add((TranslationUnit)value);
		}
	}
}